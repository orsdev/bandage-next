...
interface VariableStyle extends CSSProperties {
  "--i": string;
}

export const BallBook = () => (
  <svg
    width={72}
    height={72}
    viewBox="0 0 72 72"
...
export const OpenBook = () => (
  ...
  >
    <path
      className={Style.openBookLine}
      d="M42.75 22.5H58.5V27H42.75V22.5Z"
      fill="#23A6F0"
      style={{ "--i": "0.2s" } as VariableStyle}
    />
    <path
      className={Style.openBookLine}
      d="M42.75 33.75H58.5V38.25H42.75V33.75Z"
      fill="#23A6F0"
      style={{ "--i": "0.6s" } as VariableStyle}
    />
    <path
      className={Style.openBookLine}
      d="M42.75 45H58.5V49.5H42.75V45Z"
      fill="#23A6F0"
      style={{ "--i": "0.4s" } as VariableStyle}
    />
    <path
      className={Style.openBookLine}
      d="M13.5 22.5H29.25V27H13.5V22.5Z"
      fill="#23A6F0"
      style={{ "--i": "0.3s" } as VariableStyle}
    />
    <path
      className={Style.openBookLine}
      d="M13.5 33.75H29.25V38.25H13.5V33.75Z"
      fill="#23A6F0"
      style={{ "--i": "0.1s" } as VariableStyle}
    />
    <path
      className={Style.openBookLine}
      d="M13.5 45H29.25V49.5H13.5V45Z"
      fill="#23A6F0"
      style={{ "--i": "0.8s" } as VariableStyle}
    />
    <path
